    ...
    <>
      ...
      <div className="fixed bottom-0 right-0 z-50">
        ...
        {!isOpen && (
          ...
          >
            <svg
              className="w-8 h-8 fill-mauve-700"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill=""
            >
        ...
        {isOpen && (
          <div className="bg-mauve-900 border-2 border-mauve-700 rounded-xl shadow-2xl flex flex-col w-96 max-w-screen h-96 md:mb-4 md:mr-4">
            ...
            <div className="bg-mauve-800 p-4 border-b border-mauve-700 rounded-t-lg">
              <div className="flex justify-between items-start gap-2 mb-2">
                <div className="flex-1">
                  <h2 className="text-lg font-bold text-mauve-300">
                    Chat - {userSession.roomId}
                  </h2>
                </div>
            ...
            <ul className="flex-1 overflow-y-auto p-4 bg-mauve-800 space-y-3">
              {messages.length === 0 ? (
                ...
                messages.map((msg, idx) => (
                  <li
                    key={idx}
                    className="mb-3 last:mb-0 bg-mauve-300 rounded-xl p-2"
                  >
                    <div className="flex justify-between items-baseline gap-2">
                      <strong className="text-mauve-900 text-sm">
                        {msg.user}:
                      </strong>
                    ...
                    <div className="text-mauve-800 mt-1 text-sm ml-4 wrap-break-word whitespace-pre-wrap">
                      {msg.text}
                    </div>
                  </li>
                ))
            ...
            <form
              ...
              className="bg-mauve-800 p-3 border-t border-mauve-700 rounded-b-lg flex gap-2"
            >
              <input
                type="text"
